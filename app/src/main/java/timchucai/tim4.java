...
public class tim4 extends Activity {
	MediaPlayer mp3;
	MediaPlayer amr;
	public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.timchu);
        mp3=MediaPlayer.create(tim4.this,R.raw.mot);
        mp3.start();
		...
		g.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (+position == 27) {
					mp3 = MediaPlayer.create(tim4.this, R.raw.chinhxac);
					mp3.start();
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(tim4.this,chontrochoi.class);
				startActivity(i);
				finish();
		...
		ketiep.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(choncauhoi.f==1)
				{
					Intent myintent=new Intent(tim4.this, tim1.class);
					startActivityForResult(myintent, 1234);
					  finish(); 	
				}
				else if(choncauhoi.f==2)
				{
					Intent myintent=new Intent(tim4.this, tim2.class);
					startActivityForResult(myintent, 1234);
					  finish(); 	
				}
				else if(choncauhoi.f==3)
				{
					Intent myintent=new Intent(tim4.this, tim3.class);
					startActivityForResult(myintent, 1234);
					  finish(); 	
				}
				else if(choncauhoi.f==5)
				{
					Intent myintent=new Intent(tim4.this, tim5.class);
					startActivityForResult(myintent, 1234);
					  finish(); 	
				}
			}
	...
	public class ImageAdapter extends BaseAdapter {
		...
		private Integer[] mThumbIds = { R.drawable.t6, R.drawable.r,
				R.drawable.t2, R.drawable.b, R.drawable.t9, R.drawable.d,
				R.drawable.p, R.drawable.y, R.drawable.a2, R.drawable.d1,
				R.drawable.c, R.drawable.i, R.drawable.k, R.drawable.l,
				R.drawable.t3, R.drawable.n, R.drawable.o, R.drawable.d,
				R.drawable.o2, R.drawable.a1, R.drawable.q, R.drawable.r,
				R.drawable.s, R.drawable.t, R.drawable.u, R.drawable.u1,
				R.drawable.v, R.drawable.t1, R.drawable.e, R.drawable.x,
